...
class Agent:
    ...
    def __init__(self):
        ...
        self.model = Linear_QNet(37, 256, 7)
    ...
    def get_state(self, game: Game):
        ...
        if (y, x) in closed:
            end_state = [entry_point] + [subarray[0] for subarray in path_info]
        ...
        # 1 - 12 / path info distances
        # 43 - 54 / curr tile connects
        # 55 - 66 / swap tile connects

        state = [entry_point] + [subarray[0] for subarray in path_info]
